...
export default async function ManagementContentPage() {
  ...
  return <div className="management-page"><header className="management-page-header"><div><p className="management-kicker">Contenido</p><h1>Landing y campañas</h1><p>Controlá hero, promociones, colecciones y avisos emergentes sin modificar código.</p></div><a className="button secondary" href="/?preview=gestion" rel="noreferrer" target="_blank">Ver tienda</a></header><div className="management-content-gap"><ContentOverview content={content} /></div></div>;
}
