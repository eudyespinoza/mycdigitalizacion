  ...
  return (
    <div className="management-page">
      <header className="management-page-header">
        ...
        <div className="management-header-actions"><Link className="button secondary" href="/gestion/categorias">Categorías, marcas y atributos</Link><Link className="button primary" href="/gestion/catalogo/nuevo">Cargar producto</Link></div>
      </header>
