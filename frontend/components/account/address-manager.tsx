...
import type { Address, MapConfiguration } from "@/lib/types";
...
export function AddressManager() {
  ...
  useEffect(() => {
    void load();
    void apiRequest<MapConfiguration>("/locations/map-config/")
      .then(setMapConfiguration)
      .catch(() => setMapConfiguration(undefined));
  }, []);
  ...
  const localityCenter = current?.geocode_source === "georef" && current.geocode_summary?.precision === "locality";
