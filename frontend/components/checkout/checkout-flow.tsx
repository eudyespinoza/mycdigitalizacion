...
export function CheckoutFlow() {
  ...
  return <div className="checkout-layout">
    ...
    {error && <div className="inline-error checkout-error" role="alert"><p>{error}</p>{step === 0 && <div className="checkout-error-actions"><Link href="/cuenta">Completar datos personales</Link><Link href="/cuenta/fiscal">Cargar datos fiscales</Link></div>}</div>}
